$( document ).ready(function() {
  // $.get("http://51.254.126.24:4567/visuel-stats",
  //          function(result) { 
  //        alert(result);
  //    });
  $.getJSON("http://51.254.126.24:4567/visuel-stats", function(result){alert($('body').html(result))});
  $("h3").fadeIn(1500);
  $("#instructions").show();
...
$("#done-link").on('click', function(){
  ...
  $.post("http://51.254.126.24:4567/visuel-submit",
  {
    time: avg,
    tries: tries,
    sex: "male",
